...
class CreateHsInvoiceLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hs_invoice_log', function (Blueprint $table) {
            $table->increments('ivlg_id');
    ...
    {
        Schema::dropIfExists('hs_invoice_log');
    }
}
