            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                            {{ Form::text('quantity', old('quantity') ?  number_format(old('quantity'), 0) : '1', array('id' => 'quantity', 'class' => 'form-control w-100 amountPercentInput harmonyAmountInput', 'maxlength' => '21', 'onkeypress' => 'return isNumberPlusComma(event, $(this))')) }}
                        </div>
