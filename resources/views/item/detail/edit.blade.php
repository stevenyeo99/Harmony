    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    {!! Form::open(array('url' => route('manage.item.detail.update', $itemDetailObj->itdt_id), 'method' => 'POST', 'id' => 'frm')) !!}
                    @csrf
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                            {{ Form::text('name', old('name') ? old('name') : $itemDetailObj->name, array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                        </div>
                    ...
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                            {{ Form::text('description', old('description') ? old('description') : $itemDetailObj->description, array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                        </div>

                        {{ Form::label('splr_id', 'Supplier<span class="text-danger">*</span> :', array('class' => 'col-sm-2 col-md-2 col-lg-2 d-inline-block pl-0'), false) }}

                        <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                            {{ Form::select('splr_id', $listOfSupplier, old('splr_id') ? old('splr_id') : $itemDetailObj->splr_id, array('class' => 'form-control w-100')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                            {{ Form::select('itcg_id', $listOfItemCategory, old('itcg_id') ? old('itcg_id') : $itemDetailObj->itcg_id, array('class' => 'form-control w-100', 'maxlength' => '20')) }}
                        </div>

                        {{ Form::label('ituo_id', 'Jenis<span class="text-danger">*</span> :', array('class' => 'col-sm-2 col-md-2 col-lg-2 d-inline-block pl-0'), false) }}

                        <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                            {{ Form::select('ituo_id', $listOfItemUom, old('ituo_id') ? old('ituo_id') : $itemDetailObj->ituo_id, array('class' => 'form-control w-100', 'maxlength' => '20')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group form-inline">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                            {{ Form::text('quantity', old('quantity') ?  number_format(old('quantity'), 0) : number_format($itemDetailObj->quantity, 0), array('id' => 'quantity', 'class' => 'form-control w-100 amountPercentInput harmonyAmountInput', 'maxlength' => '21', 'readonly' => true)) }}
                        </div>
