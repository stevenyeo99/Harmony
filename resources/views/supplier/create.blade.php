    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    {!! Form::open(array('url' => route('manage.supplier.create'), 'method' => 'POST', 'id' => 'frm')) !!}
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                                {{ Form::text('telp_no', old('telp_no'), array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                                {{ Form::text('contact_name_1', old('contact_name_1'), array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                                {{ Form::text('contact_person_1', old('contact_person_1'), array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                                {{ Form::text('contact_name_2', old('contact_name_1'), array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                            </div>

                            {{ Form::label('contact_person_2', 'Kontak :', array('class' => 'col-sm-2 col-md-2 col-lg-2 d-inline-block pl-0')) }}

                            <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                                {{ Form::text('contact_person_2', old('contact_person_1'), array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                                {{ Form::text('contact_name_3', old('contact_name_3'), array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                            </div>

                            {{ Form::label('contact_person_3', 'Kontak :', array('class' => 'col-sm-2 col-md-2 col-lg-2 d-inline-block pl-0')) }}

                            <div class="col-sm-4 col-md-4 col-lg-4 pl-0">
                                {{ Form::text('contact_person_3', old('contact_person_3'), array('class' => 'form-control w-100', 'maxlength' => '50')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10 pl-0">
                                {{ Form::text('address_line_1', old('address_line_1'), array('class' => 'form-control w-100', 'maxlength' => '100')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10 pl-0">
                                {{ Form::text('address_line_2', old('address_line_2'), array('class' => 'form-control w-100', 'maxlength' => '100')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10 pl-0">
                                {{ Form::text('address_line_3', old('address_line_3'), array('class' => 'form-control w-100', 'maxlength' => '100')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10 pl-0">
                                {{ Form::text('address_line_4', old('address_line_4'), array('class' => 'form-control w-100', 'maxlength' => '100')) }}
                            </div>
                        </div>
